Option Strict Off
Option Explicit On
Friend Class frmCheckConditions
	...
	Private Sub cmdCancel_CheckStateChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdCancel.CheckStateChanged
		...
		If cmdCancel.CheckState = 1 Then
			...
			Else
				'UPGRADE_WARNING: Form method frmCheckConditions.ZOrder has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
				Me.BringToFront()
			End If
	...
	'UPGRADE_WARNING: Form event frmCheckConditions.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Private Sub frmCheckConditions_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
		Dim i As Object
        ...
        'RS.Open("Select * From ImportConditions Order By Condition", DB, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
		List1.Items.Clear()
	...
	Private Sub frmCheckConditions_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
