Public Class frmSearchOurDistract

    Private Sub frmSearchOurDistract_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DsExplosives.OURDISTRACT' table. You can move, or remove it, as needed.
        Me.OURDISTRACTTableAdapter.FillByOrderByDate(Me.DsExplosives.OURDISTRACT)
        CType(DataGridView1.DataSource, BindingSource).Filter = "DISTDATE = '" + DateTimePicker2.Value.Date + "'"
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        ...
        Select Case ComboBox1.Text
            ...
            Case "نمرة مستند الصرف"
                CType(DataGridView1.DataSource, BindingSource).Filter = "ID like %" + txtSearch.Text + "%"
    ...
    Private Sub DataGridView1_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        If MessageBox.Show("هل تود اختيار مستند الصرف؟", "تنبيه", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                CType(Application.OpenForms("frmPassPermissions"), frmPassPermissions).OurDistactID =
